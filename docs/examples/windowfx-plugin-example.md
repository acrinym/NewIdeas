...
WindowFX plugins add compositor or physics effects to Cycloside windows. The interface is defined in `Cycloside/Effects/IWindowEffect.cs`. Effects use `ISceneTarget`; use `WindowSceneAdapter.CreateFrom(window)` when you have a `Window`.
