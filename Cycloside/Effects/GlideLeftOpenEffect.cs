...
public class GlideLeftOpenEffect : IWindowEffect
{
    private readonly Dictionary<ISceneTarget, EventHandler> _handlers = new();

    public string Name => "GlideLeftOpen";
    ...
    private void OnOpened(ISceneTarget target)
    {
        ...
        var start = new PixelPoint(end.X - EffectConstants.SlideDistanceHorizontalPx, end.Y);
