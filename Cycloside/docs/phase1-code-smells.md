...
| DodgeFocusEffect, WobblyWindowEffect | `DispatcherTimer` not disposed, magic 16ms | Improper disposal, magic number | ✓ |
| MagicLampMinimizeEffect, BeamUpMinimizeEffect | 220ms, 16ms, -120 magic numbers | Magic numbers | ✓ |
